...
alter table if exists tb_sales add constraint FKp0nn0oixeiw2fq3jivj6vnsu foreign key (seller_id) references tb_sellers;create table tb_sales (id bigint not null auto_increment, amount double precision, date date, deals integer, visited integer, seller_id) bigint, primary key (id)) engine=MyISAM;
create table tb_sellers (id bigint not null auto_increment, name varchar(255), primary key (id)) engine=MyISAM;
alter table tb_sales add constraint FK1y7vqwel3cdg1t9v928fqv2q1 foreign key (seller_id)) references tb_sellers (id);
create table tb_sales (id int8 generated by default as identity, amount float8, date date, deals int4, visited int4, seller_id int8, primary key (id));
create table tb_sellers (id int8 generated by default as identity, name varchar(255), primary key (id));
